//-*- coding: utf-8 -*-
/*
Copyright 2012-2013 Oliver Lau, Heise Zeitschriften Verlag
    ...
    reader.onload = function (e) {
      if (e.target.readyState == FileReader.DONE) {
        ...
        xhr.open('POST', settings.file_upload_url +
                 '?filename=' + encodeURIComponent(progress[id].name) +
        ...
        xhr.send(new Uint8Array(e.target.result));
      }
    };
